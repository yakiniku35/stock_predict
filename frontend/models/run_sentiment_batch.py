...
def _load_rnn_runtime():
    ...
    return build_rnn_text, load_artifacts, predict_many
...
def _predict_rnn(rows: list[dict], model_dir: Path, batch_size: int) -> tuple[int, dict[str, int], str]:
    ...
    build_rnn_text, load_artifacts, predict_many = _load_rnn_runtime()
...
def _predict_rnn_subset(
    ...
    build_rnn_text, _, predict_many = _load_rnn_runtime()
...
def main() -> int:
    ...
    if args.ab_enabled:
        ...
        _, load_artifacts, _ = _load_rnn_runtime()
